...
public class LuceneIndexFiles {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Buffer Size: " + iwc.getRAMBufferSizeMB());
            IndexWriter writer = new IndexWriter(FSDirectory.open(Paths.get(indexPath)), iwc);
            indexDocs(writer, docDir);

            // NOTE: if you want to maximize search performance,  you can optionally call forceMerge here.  This can be a terribly costly operation, 
            // so generally it's only worth it when your index is relatively static (ie you're done adding documents to it):  writer.forceMerge(1);
            writer.close();
